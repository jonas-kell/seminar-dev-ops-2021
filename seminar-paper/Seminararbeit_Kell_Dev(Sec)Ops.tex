...
\usepackage{floatpag}                           %make it possible for float-pages to not have a pagenumber
...
\graphicspath{{./images/}{./attachments/}}      %custom paths for folders in that graphics can be found
...
% \includepdf{Titelseite}         %include title-page pdf
...
\Blinddocument                  %generate a whole document for testing
